...
Software Engineer from Brazil focused on backend development, software architecture, and distributed systems.

### Tech Stack

* Backend: Node.js, NestJS, TypeScript, Python, Django, Golang, Fiber
* Frontend: React, Next.js, Angular, Vue.js, HTMX
...
Always building, learning, and sharing knowledge.
